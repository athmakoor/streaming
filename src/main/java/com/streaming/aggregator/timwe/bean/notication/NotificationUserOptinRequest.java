 ...
 */
public class NotificationUserOptinRequest {
    ...
    public String toString() {
        return "NotificationUserOptinRequest{" + "productId=" + productId + ", pricepointId=" + pricepointId + ", mcc='"
                + mcc + '\'' + ", mnc='" + mnc + '\'' + ", msisdn='" + msisdn + '\'' + ", largeAccount='" + largeAccount
                + '\'' + ", entryChannel='" + entryChannel + '\'' + ", text='" + text + '\'' + ", tags=" + tags
                + ", transactionUUID='" + transactionUUID + '\'' + ", trackingId='" + trackingId + '\''
